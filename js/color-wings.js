...
(function (React$1) {
  ...
  var sendUpdateControlEvent = function sendUpdateControlEvent() {
    var _MainStore$get = MainStore.get(),
        ...
        currentPageType = _MainStore$get.currentPageType,
        allFonts = _MainStore$get.allFonts;
    ...
    currentStylesDetails[currentPage] = {
  ...
  var updateOnPageChange = function updateOnPageChange() {
    ...
    if (page !== currentPage) {
      if (isObject(control.setting._value) && page in control.setting._value) {
        var currentStyles = control.setting._value[page].styles;
  ...
  function addInitialStyles(api) {
    ...
    if ('global' in control.setting._value) {
      ...
      var keys = Object.keys(control.setting._value);
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        onClick: function onClick() {
          return MediaStore.activateQuery(key);
        },
  ...
  var LengthTab = /*#__PURE__*/function (_React$Component) {
    ...
    function LengthTab(props) {
      ...
      _defineProperty(_assertThisInitialized(_this), "resetValue", []);
      ...
      _defineProperty(_assertThisInitialized(_this), "getLength", function () {
        ...
        if (false !== value) {
          ...
          if ('values' in _this.props) {
            size = _this.props.values[_this.props.tab];
          }
        }
      ...
      _defineProperty(_assertThisInitialized(_this), "reset", function () {
        var _this$resetValue = _slicedToArray(_this.resetValue, 2),
            main = _this$resetValue[0],
            unit = _this$resetValue[1];
      ...
      var _this$getLength = _this.getLength(),
          ...
          _main = _this$getLength2[0],
          _unit = _this$getLength2[1];
    ...
    _createClass(LengthTab, [{
      ...
      value: function componentDidUpdate(prev) {
        if (this.props.val !== prev.val) {
          var _this$getLength3 = this.getLength(),
              _this$getLength4 = _slicedToArray(_this$getLength3, 2),
              main = _this$getLength4[0],
              unit = _this$getLength4[1];
  ...
  var Length = /*#__PURE__*/function (_React$Component) {
    ...
    function Length(props) {
      ...
      if (splits.length === 4) {
        ...
        _values = ['0px', splits[0], splits[1], splits[2], splits[1]];
      } else if (splits.length === 2) {
        _values = ['0px', splits[0], splits[1], splits[0], splits[1]];
      }
    ...
    _createClass(Length, [{
      ...
      value: function render() {
        ...
        return /*#__PURE__*/React.createElement("div", {
          className: "cw-control-content cw-length " + (this.showShortHand ? 'shorthand' : 'single-length')
  ...
  */
    ...
    return /*#__PURE__*/React$1__default.createElement("div", {
      ...
      if (option.type === 'group') {
        return /*#__PURE__*/React$1__default.createElement("li", {
          ...
          className: cls('options')
        }, option.items.map(o => /*#__PURE__*/React$1__default.createElement(Option$1, _extends$1({
          key: o.value,
          cls: cls,
      ...
      return /*#__PURE__*/React$1__default.createElement(Option$1, _extends$1({
        key: option.value,
        cls: cls,
        optionProps: optionProps,
  ...
  SelectSearch.defaultProps = {
    ...
    printOptions: 'auto',
    closeOnSelect: true,
    renderOption: (domProps, option, snapshot, className) => /*#__PURE__*/React$1__default.createElement("button", _extends$1({
      className: className
  ...
  function Select(props) {
    ...
    var renderOptionWithCls = function renderOptionWithCls(props, option, snapshot, className) {
  ...
  function QuickSelect(_ref) {
    ...
    var rightArrow = /*#__PURE__*/React.createElement("svg", {
      ...
      d: "M16.12 4.4v4.16H4.57c.46-.28.49-.3.74-.49.24-.19.72-.83.57-1.3-.1-.3-.38-.56-.57-.84a1.64 1.64 0 01-.06-1.55l10.87.02z",
      fill: "#D0FFAD"
    }), /*#__PURE__*/React.createElement("path", {
      d: "M14.76 6.47l-3.25-3.25A2.18 2.18 0 1114.6.14l2.8 2.8h0l2.8 2.8c.4.4.4 1.06 0 1.46l-5.6 5.6a2.18 2.18 0 11-3.08-3.08l3.25-3.25z",
      stroke: "#08850F",
      fill: "#BEFA91",
      fillRule: "nonzero"
    }), /*#__PURE__*/React.createElement("path", {
      d: "M19.84 6.85l-5.6 5.6c-.82.81-2.26.6-2.73-.54a5.82 5.82 0 012.2-1.75c1.01-.45 1.93-.55 3.1-1.38.49-.35.93-.76 1.21-1.27.3-.52.42-1.13.28-1.7-.17-.68-.67-1.19-.67-1.93l2.2 2.2c.22.22.22.56 0 .77z",
      fill: "#D0FFAD",
      fillRule: "nonzero"
    }), /*#__PURE__*/React.createElement("path", {
      d: "M12.62 1.36c-.07.3.1.64.3.73.15.08.35.03.52.06.25.05.45.24.68.35.08.03.18.06.25.01.08-.04.1-.14.1-.23a.58.58 0 00-.13-.24c-.25-.33-1.5-1.63-1.72-.68z",
      fill: "#FFF",
      fillRule: "nonzero"
    })));
    return /*#__PURE__*/React.createElement("div", {
  ...
  function Panel() {
      ...
      setPopState(function (prevPopState) {
        return {
          ...
          style: {
            ...
            arrow: {
              right: "".concat(clientRect.width / 2, "px")
            }
          }
        };
      });
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }), /*#__PURE__*/React.createElement("ul", null, allPages.map(function (page) {
      return /*#__PURE__*/React.createElement("li", {
        key: page.name,
        onClick: function onClick() {
      ...
      className: 'tab-content' + (tab !== 'editor' ? ' hidden' : '')
    }, /*#__PURE__*/React.createElement(Editor, null)), /*#__PURE__*/React.createElement("div", {
      className: 'tab-content' + (tab !== 'code' ? ' hidden' : '')
